...
ChatLogic::~ChatLogic()
{
    ...
    // delete _chatBot;
    // The chatbot is deleted by the node it is attached to
    ...
    //     delete *it;
    // }
    // GraphNodes are now smart pointers and are deleted automatically when the instance goes out of scope
    ...
    //     delete *it;
    // }
    // Edges are now owned by GraphNode and deleted when the GraphNode goes out of scope
